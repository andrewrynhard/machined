...
import (
	...
	"github.com/talos-systems/machined/internal/sysctl"
)
...
// CheckKSPPKernelParameters verifies that all required KSPP kernel
// parameters are present with the right value.
func CheckKSPPKernelParameters() error {
...
// WriteKSPPSysctls verifies that all required KSPP kernel sysctls are set
// with the right value.
func WriteKSPPSysctls() (err error) {
